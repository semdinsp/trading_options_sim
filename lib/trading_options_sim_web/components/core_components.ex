defmodule TradingOptionsSimWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TradingOptionsSimWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TradingOptionsSimWeb.Gettext, "errors", msg, opts)
    end
  end
