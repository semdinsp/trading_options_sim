defmodule TradingOptionsSimWeb.Api.Serializer do
  ...
  def strategy_version(version) do
    %{
      ...
      "promoted_to_live_app" => version.promoted_to_live_app,
      "promoted_to_live_strategy_id" => version.promoted_to_live_strategy_id,
      "promoted_to_live_at" => str(version.promoted_to_live_at),
