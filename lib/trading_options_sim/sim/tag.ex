defmodule TradingOptionsSim.Sim.Tag do
  ...
  for filtering/grouping during testing and quarantine review — ported
  from `trading_system.Trading.Tag`/`trading_live.LiveTrading.Tag`'s
  identical pattern (see `OPTIONS_SIM_ARCHITECTURE_PLAN.md` §3a). This
  app's own local, independent tag pool — not shared with either
  sibling, matching that precedent exactly.
